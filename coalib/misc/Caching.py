...
from coalib.misc.CachingUtilities import (
    pickle_load, pickle_dump, delete_cache_files, hash_id)
...
class FileCache:
    ...
    def __init__(
        ...
        if "files" in cache_data and not flush_cache:
            self.data = cache_data["files"]
        else:
            self.flush_cache()
    ...
    def flush_cache(self):
        ...
        """
        self.data = {}
        delete_cache_files(self.log_printer, [self.project_dir])
